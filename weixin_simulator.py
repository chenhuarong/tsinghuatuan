...
url_menu = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token=htGu_LAPRAN3qWVXMox4U1nk_DbFyb8L8MfggcwGBFFUKSfYZ8SnTzg6RTChLYag3pRfGqkZPVC7cfqYhD9LyuuRYXh7WfU250o_F3beYrLo1Qg0c-TRQxAk2mFLnX6c1oZR6Qns7iCxqU_BOSnW8g"
...
while True:
    ...
    data = '{"button":[{"name":"资讯","sub_button":[{"type":"click","name":"新闻","key":"TSINGHUA_WECHAT_NEWS"},' \
           '{"type":"click","name":"活动","key":"TSINGHUA_WECHAT_ACTIVITY"},{"type":"click","name":"讲座","key":' \
           '"TSINGHUA_WECHAT_LECTURE"},{"type":"click","name":"查询","key":"TSINGHUA_WECHAT_QUERY"}]},{"name":"服务",' \
           '"sub_button":[{"type":"click","name":"订票","key":"TSINGHUA_WECHAT_BOOK"},{"type":"click","name":"指路",' \
           '"key":"TSINGHUA_WECHAT_PATH"},{"type":"click","name":"吐槽","key":"TSINGHUA_WECHAT_CONFIDE"},{"type":"click",' \
           ...
           '"click","name":"社团","key":"TSINGHUA_WECHAT_COMMUNITY"},{"type":"click","name":"帮助","key":' \
           '"TSINGHUA_WECHAT_HELP"}]}]}'
